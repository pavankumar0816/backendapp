...
studentrouter.get("/jobseekerprofile/:studentid",studentcontroller.studentprofile)


studentrouter.get("/viewcourses",studentcontroller.viewcourses)
studentrouter.post("/registercourses/:coursecode", studentcontroller.registerCourse);
...
studentrouter.get("/assessmentfile/:filename",studentcontroller.assessmentfile)

studentrouter.get("/viewstudentmappedcourses",studentcontroller.viewStudentMappedCourses)
